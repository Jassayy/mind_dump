...
const DumpCard: React.FC<DumpCardProps> = ({ content, mood, createdAt }) => {
  ...
  return (
    <div className="group p-5 rounded-lg bg-linear-to-br from-white to-zinc-50 dark:from-zinc-900 dark:to-zinc-950 border border-zinc-200 dark:border-zinc-800 hover:border-blue-300 dark:hover:border-blue-700 hover:shadow-md transition-all duration-200 cursor-pointer">
